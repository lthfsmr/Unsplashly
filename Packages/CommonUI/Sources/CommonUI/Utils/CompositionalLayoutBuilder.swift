...
public struct CompositionalLayoutBuilder {
  ...
  public func build(subItems: [NSCollectionLayoutItem]) -> NSCollectionLayoutSection {
    let group = NSCollectionLayoutGroup.horizontal(
      layoutSize: groupLayoutSize ?? NSCollectionLayoutSize(
  ...
  public func build(repeatingSubItemCount: Int) -> NSCollectionLayoutSection {
    let itemSizePlaceholder = NSCollectionLayoutSize(
      widthDimension: .fractionalWidth(1),
      heightDimension: .estimated(1000)
    )
    ...
    let groupSizePlaceholder = NSCollectionLayoutSize(
      widthDimension: .fractionalWidth(1),
      heightDimension: .estimated(1000)
    )
    let group = NSCollectionLayoutGroup.horizontal(
      layoutSize: groupLayoutSize ?? groupSizePlaceholder,
      subitem: item,
